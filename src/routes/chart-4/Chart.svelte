<script>
	...
	const height = chartHeight + axisHeight;
	...
	const yScale = d3.scaleBand().domain(yDomain).range([chartHeight, 0]);
...
<div class="container">
	<svg {width} {height} viewBox={`0 0 ${width} ${height}`}>
		...
		<g bind:this={axisGroup} transform={`translate(${legendWidth}, ${chartHeight})`}> </g>
	</svg>
